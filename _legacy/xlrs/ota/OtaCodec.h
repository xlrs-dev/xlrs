...
//
// Control frame: [header][packed 11-bit channels]. Header carries version + OtaType (§OtaPacket).
...
// Decode a control frame of `n` channels. Returns false on wrong version/type or short length.
...
// Carries the RX's measurement of the uplink so the TX side can show "how well my craft
